...
abstract class DevMoneroBackgroundSyncBase with Store {
  ...
  Future<void> manualRescan() async {
    await wallet.rescan(height: await monero!.getNodeHeight(wallet) - 10000);
  }
  ...
  @action
  Future<void> startBackgroundSync() => monero!.startBackgroundSync(wallet);

  @action
  Future<void> stopBackgroundSync() async {
    final keyService = getIt.get<KeyService>();
    await monero!.stopBackgroundSync(
      wallet,
